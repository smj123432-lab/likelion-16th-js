...
let grandParent =
  anotherTarget.parentElement.parentElement.parentElement.parentElement;
...
const targetStrong = document.querySelector(
  '[data-list-type="ordered-list"] li:last-child strong',
);
...
const firstItem = document.querySelector(".faq-list");

const secondItem = firstItem.children;

const thirdItem = secondItem[secondItem.length - 1];
