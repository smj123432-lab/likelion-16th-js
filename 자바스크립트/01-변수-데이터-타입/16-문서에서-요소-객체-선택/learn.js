...
// 그 밖의 요소 선택 API (참고)
// --------------------------------------------------------------------------
const heros = document.getElementById('exorcist-characters')
console.log(heros);
// const heroos = heros.querySelector('li')
// console.log(heroos);

// 요한
// 요한 태그
let yohan = null
yohan = heros.getElementsByName('li').item(0)
// 요한 클래스
yohan = heros.querySelector('li')
// 요한 속성 이름 값으로 찾기
yohan = heros.getElementsByClassName('character').item(0)
console.log(yohan);
//const heros = document.querySelector('#exorcist-characters')
