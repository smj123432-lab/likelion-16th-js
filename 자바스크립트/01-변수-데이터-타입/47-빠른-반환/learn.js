...
function getStore(score) {
  if (score === 100) return "notebook";
  if (score > 75) return "tablit";
  if (score > 50) return "smartphone";
  return "없음";
}
console.log(getStore(45));
console.log(getStore(76));
console.log(getStore(55));
console.log(getStore(100));
...
function deletePost(user) {
  ...
  // 관리자가 아니면 즉시 반환
  if (!user.isAdmin) return "관리자 권한 필요";
  // 모든 관문을 통과함
  return "삭제 성공";
}
