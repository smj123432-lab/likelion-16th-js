...
async function handleLoginSubmit(e) {
  ...
  try {
    ...
    const [
      ...
      fetch(`${API_BASE_URL}/carts/user/${id}`).then((res) => res.json()),
      fetch(`${API_BASE_URL}/products`).then((res) => res.json()),
      fetch(`${API_BASE_URL}/recipes`).then((res) => res.json()),
      fetch(`${API_BASE_URL}/posts/user/${id}`).then((res) => res.json()),
      fetch(`${API_BASE_URL}/comments`).then((res) => res.json()),
      fetch(`${API_BASE_URL}/todos/user/${id}`).then((res) => res.json()),
      fetch(`${API_BASE_URL}/quotes`).then((res) => res.json()),
    ]);
    // - carts/user/${id}
    // - products
    // - recipes
